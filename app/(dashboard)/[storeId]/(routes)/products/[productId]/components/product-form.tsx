...
// Interface props tidak perlu diubah
...
// PERUBAHAN 1: Skema Zod diperbaiki
const formSchema = z.object({
  name: z.string().min(1),
  images: z.object({ url: z.string() }).array(),
  price: z.coerce.number().min(1),
  categoryId: z.string().min(1),
  isFeatured: z.boolean().default(false), // .optional() dihapus karena sudah ada .default()
  isArchived: z.boolean().default(false), // .optional() dihapus
});
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const description = initialData ? "Atur Product Anda" : "Buat Product Toko";
